 sbatch -o ./baselines/256_64_%j.out --qos=tenenbaum --gres=gpu:titan-x:1 --time=180 anaconda-project run python ./make-baseline.py --min_examples=1 --max_examples=1 --hidden_size=256 --embedding_size=64
